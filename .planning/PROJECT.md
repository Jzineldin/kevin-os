...
| Claude Agent SDK for orchestration, not LangGraph/CrewAI | Subagents as markdown files in `.claude/agents/`; lower RAM, faster ship, MCP-native; Anthropic-blessed pattern | — Pending |
