 ...
 * triage handler must import hybridQuery from @kos/azure-search AND pass an
 * azureSearch callable to loadContext that projects HybridQueryResult.hits
 * (NOT .results — the VERIFICATION.md prose typo).
 *
 * Pure file-content assertions — no Lambda runtime, no pool, no AWS SDK
 * mocking required.
 */
