 ...
 * voice-capture handler must import hybridQuery from @kos/azure-search AND
 * pass an azureSearch callable to loadContext that projects
 * HybridQueryResult.hits (NOT .results — the VERIFICATION.md prose typo).
 */
